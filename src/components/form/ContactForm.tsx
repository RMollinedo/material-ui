...
import { Alert, AlertTitle, Checkbox, Dialog, SelectChangeEvent, Button, ListItemText, MenuItem, Paper, Stack } from "@mui/material";
...
export default function ContactForm() {
  ...
  const getDefaultFormValues = () => {
    return {
      ...
      startDate: `${today.month() + 1}/${today.date}/${today.year}`,
